...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        schemas.put("ComparecimentoDTO", new ObjectSchema()
        ...
        schemas.put("EnderecoDTO", new ObjectSchema()
        ...
        schemas.put("EstatisticasComparecimento", new ObjectSchema()
        ...
        schemas.put("ExemploComparecimentoPresencial", new ObjectSchema()
        ...
        schemas.put("ExemploComparecimentoComMudanca", new ObjectSchema()
